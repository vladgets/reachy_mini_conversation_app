...
from reachy_mini_conversation_app_vlad.tools.core_tools import (
    ToolDependencies,
    get_active_tool_specs,
)
from reachy_mini_conversation_app_vlad.conversation_handler import ConversationHandler
from reachy_mini_conversation_app_vlad.camera_frame_encoding import encode_bgr_frame_as_jpeg
from reachy_mini_conversation_app_vlad.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class GeminiLiveHandler(ConversationHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        """
        try:
            from reachy_mini_conversation_app_vlad.config import set_custom_profile
