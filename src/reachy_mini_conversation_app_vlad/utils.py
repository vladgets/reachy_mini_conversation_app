...
from reachy_mini_conversation_app_vlad.camera_worker import CameraWorker
from reachy_mini_conversation_app_vlad.vision.head_tracking import HeadTracker


if TYPE_CHECKING:
    from reachy_mini_conversation_app_vlad.vision.local_vision import VisionProcessor
...
def initialize_camera_and_vision(
    ...
    if not args.no_camera:
        if args.head_tracker is not None:
            try:
                if args.head_tracker == "yolo":
                    from reachy_mini_conversation_app_vlad.vision.head_tracking.yolo_process import (
                    ...
                    from reachy_mini_conversation_app_vlad.vision.head_tracking.mediapipe import (
        ...
        if args.local_vision:
            ...
            try:
                from reachy_mini_conversation_app_vlad.vision.local_vision import initialize_vision_processor
